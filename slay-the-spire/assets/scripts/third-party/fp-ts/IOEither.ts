 ...
 * @since 3.0.0
 */
export interface IOEither<E, A> extends I.IO<E.Either<E, A>> {}
 ...
 * @since 3.0.0
 */
export const rightIO: <A, E = never>(ma: I.IO<A>) => IOEither<E, A> =
  /*#__PURE__*/
  ET.rightF(I.Functor)
 ...
 * @since 3.0.0
 */
export const leftIO: <E, A = never>(me: I.IO<E>) => IOEither<E, A> =
  /*#__PURE__*/
  ET.leftF(I.Functor)
 ...
 * @since 3.0.0
 */
export const match: <E, B, A>(onLeft: (e: E) => B, onRight: (a: A) => B) => (ma: IOEither<E, A>) => I.IO<B> =
  /*#__PURE__*/
  ET.match(I.Functor)
...
export const matchW: <E, B, A, C>(
  onLeft: (e: E) => B,
  onRight: (a: A) => C
) => (ma: IOEither<E, A>) => I.IO<B | C> = match as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const matchE: <E, B, A>(onLeft: (e: E) => I.IO<B>, onRight: (a: A) => I.IO<B>) => (ma: IOEither<E, A>) => I.IO<B> =
  /*#__PURE__*/
  ET.matchE(I.Monad)
...
export const matchEW: <E, B, A, C>(
  onLeft: (e: E) => I.IO<B>,
  onRight: (a: A) => I.IO<C>
) => (ma: IOEither<E, A>) => I.IO<B | C> = matchE as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const getOrElse: <E, A>(onLeft: (e: E) => A) => (ma: IOEither<E, A>) => I.IO<A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const getOrElseW: <E, B>(onLeft: (e: E) => B) => <A>(ma: IOEither<E, A>) => I.IO<A | B> = getOrElse as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const getOrElseE: <E, A>(onLeft: (e: E) => I.IO<A>) => (ma: IOEither<E, A>) => I.IO<A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const getOrElseEW: <E, B>(onLeft: (e: E) => I.IO<B>) => <A>(ma: IOEither<E, A>) => I.IO<A | B> = getOrElseE as any
 ...
 * @since 3.0.0
 */
export const toUnion: <E, A>(fa: IOEither<E, A>) => I.IO<E | A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const orElseFirstIOK: <E, B>(onLeft: (e: E) => I.IO<B>) => <A>(ma: IOEither<E, A>) => IOEither<E, A> = (onLeft) =>
 ...
 * @since 3.0.0
 */
export const orLeft: <E1, E2>(onLeft: (e: E1) => I.IO<E2>) => <A>(fa: IOEither<E1, A>) => IOEither<E2, A> =
  /*#__PURE__*/
  ET.orLeft(I.Monad)
