 ...
 * @since 3.0.0
 */
export const rightTask: <A, E = never>(ma: T.Task<A>) => TaskEither<E, A> =
  /*#__PURE__*/
  ET.rightF(T.Functor)
 ...
 * @since 3.0.0
 */
export const leftTask: <E, A = never>(me: T.Task<E>) => TaskEither<E, A> =
  /*#__PURE__*/
  ET.leftF(T.Functor)
 ...
 * @since 3.0.0
 */
export const match: <E, B, A>(onLeft: (e: E) => B, onRight: (a: A) => B) => (ma: TaskEither<E, A>) => T.Task<B> =
  /*#__PURE__*/
  ET.match(T.Functor)
...
export const matchW: <E, B, A, C>(
  onLeft: (e: E) => B,
  onRight: (a: A) => C
) => (ma: TaskEither<E, A>) => T.Task<B | C> = match as any
...
) => (ma: TaskEither<E, A>) => T.Task<B | C> = matchE as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const getOrElse: <E, A>(onLeft: (e: E) => A) => (ma: TaskEither<E, A>) => T.Task<A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const getOrElseW: <E, B>(onLeft: (e: E) => B) => <A>(ma: TaskEither<E, A>) => T.Task<A | B> = getOrElse as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const getOrElseE: <E, A>(onLeft: (e: E) => T.Task<A>) => (ma: TaskEither<E, A>) => T.Task<A> =
  /*#__PURE__*/
...
export const getOrElseEW: <E, B>(
  onLeft: (e: E) => T.Task<B>
) => <A>(ma: TaskEither<E, A>) => T.Task<A | B> = getOrElseE as any
...
/**
 * Transforms a `Promise` that may reject to a `Promise` that never rejects and returns an `E.Either` instead.
 *
 * See also [`tryCatchK`](#trycatchk).
 *
 * @example
 * import { left, right } from 'fp-ts/E.Either'
 ...
 * @since 3.0.0
 */
export const toUnion: <E, A>(fa: TaskEither<E, A>) => T.Task<E | A> =
  /*#__PURE__*/
 ...
 *
 * @example
 * import * as E from 'fp-ts/E.Either'
 ...
 * @since 3.0.0
 */
export const orElseFirstTaskK: <E, B>(onLeft: (e: E) => T.Task<B>) => <A>(ma: TaskEither<E, A>) => TaskEither<E, A> = (
  onLeft
 ...
 * @since 3.0.0
 */
export const orLeft: <E1, E2>(onLeft: (e: E1) => T.Task<E2>) => <A>(fa: TaskEither<E1, A>) => TaskEither<E2, A> =
  /*#__PURE__*/
  ET.orLeft(T.Monad)
 ...
 *
 * See [`getApplicativeValidation`](./E.Either.ts.html#getapplicativevalidation).
 *
 * @category instances
 * @since 3.0.0
 */
 ...
 * get all errors you need to provide an way to concatenate them via a `Semigroup`.
 *
 * See [`getAltValidation`](./E.Either.ts.html#getaltvalidation).
 *
 * @category instances
 * @since 3.0.0
 */
...
export const traverseReadonlyNonEmptyArrayWithIndexSeq = <A, E, B>(f: (index: number, a: A) => TaskEither<E, B>) => (
  as: ReadonlyNonEmptyArray<A>
    ...
    _.tail(as).reduce<Promise<E.Either<E, NonEmptyArray<B>>>>(
      (acc, a, i) =>
        acc.then((ebs) =>
          _.isLeft(ebs)
            ? acc
