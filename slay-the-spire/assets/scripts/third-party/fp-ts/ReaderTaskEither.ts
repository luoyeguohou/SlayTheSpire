 ...
 * @since 3.0.0
 */
export const rightTask: <A, R, E = never>(ma: T.Task<A>) => ReaderTaskEither<R, E, A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const leftTask: <E, R, A = never>(me: T.Task<E>) => ReaderTaskEither<R, E, A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const rightReader: <R, A, E = never>(ma: R.Reader<R, A>) => ReaderTaskEither<R, E, A> = (ma) => flow(ma, TE.right)

/**
 * @category constructors
 * @since 3.0.0
 */
export const leftReader: <R, E, A = never>(me: R.Reader<R, E>) => ReaderTaskEither<R, E, A> = (me) => flow(me, TE.left)

/**
 * @category constructors
 * @since 3.0.0
 */
export const rightReaderTask: <R, A, E = never>(ma: RT.ReaderTask<R, A>) => ReaderTaskEither<R, E, A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const leftReaderTask: <R, E, A = never>(me: RT.ReaderTask<R, E>) => ReaderTaskEither<R, E, A> =
  /*#__PURE__*/
  ET.leftF(RT.Functor)
...
export const matchW: <E, B, A, C>(
  onLeft: (e: E) => B,
  onRight: (a: A) => C
) => <R>(ma: ReaderTaskEither<R, E, A>) => RT.ReaderTask<R, B | C> = match as any
...
) => <R1>(ma: ReaderTaskEither<R1, E, A>) => RT.ReaderTask<R1 & R2 & R3, B | C> = matchE as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const getOrElse: <E, A>(onLeft: (e: E) => A) => <R>(ma: ReaderTaskEither<R, E, A>) => RT.ReaderTask<R, A> =
  /*#__PURE__*/
...
export const getOrElseW: <E, B>(
  onLeft: (e: E) => B
) => <R, A>(ma: ReaderTaskEither<R, E, A>) => RT.ReaderTask<R, A | B> = getOrElse as any
...
export const getOrElseEW: <E, R2, B>(
  onLeft: (e: E) => RT.ReaderTask<R2, B>
) => <R1, A>(ma: ReaderTaskEither<R1, E, A>) => RT.ReaderTask<R1 & R2, A | B> = getOrElseE as any
 ...
 * @since 3.0.0
 */
export const toUnion: <R, E, A>(fa: ReaderTaskEither<R, E, A>) => RT.ReaderTask<R, E | A> =
  /*#__PURE__*/
