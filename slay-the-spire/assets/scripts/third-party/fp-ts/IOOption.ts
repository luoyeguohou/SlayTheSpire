 ...
 * @since 3.0.0
 */
export const match: <B, A>(onNone: () => B, onSome: (a: A) => B) => (ma: IOOption<A>) => I.IO<B> =
  /*#__PURE__*/
  OT.match(I.Functor)
 ...
 * @since 3.0.0
 */
export const matchW: <B, A, C>(onNone: () => B, onSome: (a: A) => C) => (ma: IOOption<A>) => I.IO<B | C> = match as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const matchE: <B, A>(onNone: () => I.IO<B>, onSome: (a: A) => I.IO<B>) => (ma: IOOption<A>) => I.IO<B> =
  /*#__PURE__*/
  OT.matchE(I.Chain)
...
export const matchEW: <B, A, C>(
  onNone: () => I.IO<B>,
  onSome: (a: A) => I.IO<C>
) => (ma: IOOption<A>) => I.IO<B | C> = matchE as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const getOrElse: <A>(onNone: Lazy<A>) => (fa: IOOption<A>) => I.IO<A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const getOrElseW: <B>(onNone: Lazy<I.IO<B>>) => <A>(ma: IOOption<A>) => I.IO<A | B> = getOrElse as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const getOrElseE: <A>(onNone: Lazy<I.IO<A>>) => (fa: IOOption<A>) => I.IO<A> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const getOrElseEW: <B>(onNone: Lazy<I.IO<B>>) => <A>(ma: IOOption<A>) => I.IO<A | B> = getOrElseE as any

/**
 * @category destructors
 * @since 3.0.0
 */
export const toUndefined: <A>(ma: IOOption<A>) => I.IO<A | undefined> = I.map(O.toUndefined)

/**
 * @category destructors
 * @since 3.0.0
 */
export const toNullable: <A>(ma: IOOption<A>) => I.IO<A | null> = I.map(O.toNullable)
 ...
 * @since 3.0.0
 */
export const fromOptionK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => O.Option<B>) => (...a: A) => IOOption<B> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const chainOptionK: <A, B>(f: (a: A) => O.Option<B>) => (ma: IOOption<A>) => IOOption<B> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const filterMap: <A, B>(f: (a: A) => O.Option<B>) => (fga: IOOption<A>) => IOOption<B> =
  /*#__PURE__*/
